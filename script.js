...
{ id: 'describeroom-choices', type: 'choice', choices: [
    { text: 'Examine the books.', nextId: 'examinebooks-1', onSelect: () => { 
        storyState.set('examinedBooks', true); 
        console.log('Variable $examinedBooks set to:', storyState.variables.examinedBooks);
    }},
    { text: 'Examine the runes.', nextId: 'examinerunes-1', onSelect: () => { 
        storyState.set('examinedRunes', true); 
        console.log('Variable $examinedRunes set to:', storyState.variables.examinedRunes);
    }}
], delay: 1500 },

{ id: 'examinebooks-1', type: 'npc', text: 'Alright, let\'s see if any of these books are useful.', delay: 1000, nextId: 'examinebooks-wait' },
{ id: 'examinebooks-wait', type: 'story', text: 'Waiting 10 minutes', delay: 1000, nextId: 'examinebooks-2' }, // 10-minute delay
{ id: 'examinebooks-2', type: 'npc', text: 'Okay... these books are strange.', delay: 1000, nextId: 'examinebooks-3' },
{ id: 'examinebooks-3', type: 'npc', text: 'They\'re written in a language I don\'t recognize. The letters shift when I try to focus on them, like they don\'t want to be read.', delay: 1000, nextId: 'examinebooks-4' },
{ id: 'examinebooks-4', type: 'npc', text: 'And some of them... breathe. The pages flutter on their own, like they\'re alive. Not in a friendly way, either. More like they\'re waiting.', delay: 1000, nextId: 'examinebooks-5' },
{ id: 'examinebooks-5', type: 'npc', text: 'I don\'t think they\'re meant for me. Or maybe they are, but not yet.', delay: 1000, nextId: 'examinebooks-6' },
{ id: 'examinebooks-6', type: 'npc', text: 'Maybe there\'s a clue somewhere else in the tower—something that could help me understand them.', delay: 1000, nextId: 'examinebooks-7' },
{ id: 'examinebooks-7', type: 'npc', text: 'For now, I\'d rather not risk opening one at random. Not until I know what I\'m dealing with.', delay: 1000, nextId: 'examinebooks-conditional' },
{ id: 'examinebooks-conditional', type: 'choice', choices: storyState.get('examinedRunes') ? [
...
{ id: 'tryreadbook-3', type: 'npc', text: 'I really have no idea what will happen if I open one. And I\'m not sure if I wanna know.', delay: 1000, nextId: 'tryreadbook-conditional' },
{ id: 'tryreadbook-conditional', type: 'choice', choices: storyState.get('examinedRunes') ? [
    { text: 'Look around the room.', nextId: 'lookaround-1' },
...
{ id: 'openbook-1', type: 'npc', text: 'Here goes nothing...', delay: 1000, nextId: 'openbook-2', onArrival: () => { 
    ...
    console.log('Variable $readBook set to:', storyState.variables.readBook);
} },
...
{ id: 'keepreading-6', type: 'npc', text: 'No, no, no, NO—', delay: 1000, nextId: 'demo-end' },
